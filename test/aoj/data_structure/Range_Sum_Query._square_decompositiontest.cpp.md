...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/data_structure/Range_Sum_Query._square_decompositiontest.cpp\"\
    ...
    \          now += data_[i];\n        }\n      }\n    }\n    return now;\n  }\n\
    };\n#line 4 \"test/aoj/data_structure/Range_Sum_Query._square_decompositiontest.cpp\"\
    \nint main(){\n  int N,Q;cin>>N>>Q;\n  RSQ<ll> rsq(N);\n  while(Q--){\n    int\
    \ t;cin>>t;\n    if(t==0){\n      ll i,x;cin>>i>>x;\n      rsq.add(i-1,x);\n \
  ...
  requiredBy: []
  timestamp: '2023-02-19 14:27:57+09:00'
  verificationStatus: LIBRARY_NO_TESTS
  verifiedWith: []
documentation_of: test/aoj/data_structure/Range_Sum_Query._square_decompositiontest.cpp
layout: document
redirect_from:
- /library/test/aoj/data_structure/Range_Sum_Query._square_decompositiontest.cpp
- /library/test/aoj/data_structure/Range_Sum_Query._square_decompositiontest.cpp.html
